      ...
      <div class="max-w-2xl mx-auto py-16 px-4 sm:py-24 sm:px-6 lg:max-w-7xl lg:px-8 lg:grid lg:grid-cols-2 lg:gap-x-8">
            ...
            <div class="flex items-center">
              ...
              <div class="ml-4 pl-4 border-l border-gray-300">
                ...
                <div class="flex items-center">
                  <div>
                    <div class="flex items-center">
                      <StarIcon v-for="rating in [0, 1, 2, 3, 4]" :key="rating" :class="[productDetails.rating > rating ? 'text-yellow-400' : 'text-gray-300', 'h-5 w-5 flex-shrink-0']" aria-hidden="true" />
                    </div>
        ...
        <div class="mt-10 lg:mt-0 lg:col-start-2 lg:row-span-2 lg:self-center">
          <div class="aspect-w-1 aspect-h-1 rounded-lg overflow-hidden">
            <NuxtImg :src="productDetails.image" :alt="product.imageAlt" class="w-full h-full object-center object-cover" />
          </div>
        </div>
